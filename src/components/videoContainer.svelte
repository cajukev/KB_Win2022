...
<div class="grid " on:mouseover={swap} on:focus={swap}  >
	<video bind:this={video} controls src="video{num}.mkv" class="row-start-1 row-span-1 col-start-1 col-span-1 w-full z-0 aspect-[37/54]"/>
	<picture bind:this={thumbnail} id="thumbnail" class="row-start-1 row-span-1 col-start-1 col-span-1 z-10 w-full aspect-h-1 aspect-[37/54]">
		<source
