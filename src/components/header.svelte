...
>
	...
	<div
		class="text-center relative mx-10 
  sm:mx-0 sm:shadow-lg sm:shadow-shadowColor sm:text-left sm:bg-zinc-50   sm:grid sm:animate-tagFadeSlideIn"
	>
		<p
			class="font-semibold self-end text-[clamp(16px,2vw,36px)] 
    sm:px-[1.5em]"
		>
			Kevin Brousseau
		</p>
